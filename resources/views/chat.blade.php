                    ...
                    <div class="profile">
                        ...
                        @if (Session::get('username') == 'adminVest')
                            <div class="text-end mt-3">
                                ...
                                <div class="text-center">
                                    <a href="{{ url('admin') }}" class="btn btn-sm mt-2 hijauuu"
                                        style="width: 100px;">
                        ...
                        @elseif (!empty(Session::get('username')))
                            <div class="text-end mt-3">
                                ...
                                <div class="text-center">
                                    <a href="{{ url('profile') }}" class="btn btn-sm mt-2 hijauuu"
                                        style="width: 100px;">
            ...
            <wait class="overlay">
                ...
                <div class="container mt-5 text-center">
                    <div class="alert alert-warning alert-dismissible fade show" role="alert"
                        ...
                        <h5 style="color: aliceblue"><strong>Perhatian!</strong> Jika Anda ingin mengakses fitur chat,
                            Anda
